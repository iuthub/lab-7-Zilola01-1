...
SELECT directors.first_name, directors.last_name FROM movies_genres JOIN movies_directors ON movies.id=movies_directors.movie_id JOIN directors ON directors.id=movies_directors.director_id WHERE movies_genres.genre="Horror";
